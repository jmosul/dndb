<template>
    <section class="create npc">
        <div class="hero">
            <div class="hero-body">
                <h1 class="title">Create Encounter</h1>
            </div>
        </div>
...
<script>
    ...
    export default class CreateEncounter extends AppComponent {
        ...
        get createMutation() {
            ...
            return this.$Amplify.graphqlOperation(createEncounter, {input: this.model});
        }
    }
</script>

                            ...
                            <div class="column is-two-thirds">
                                ...
                                <section>
                                    ...
                                    <p>
                                        ...
                                        <alignment :moral="data.getNonPlayerCharacter.alignment_moral" :order="data.getNonPlayerCharacter.alignment_order"></alignment>
                                    </p>

                                    <p
                                        v-for="detail in details"
                                        :key="detail.id"
                                        v-if="data.getNonPlayerCharacter[detail.id]"
                                    >
                                        <strong>{{detail.title}}: </strong>
                                        <span class="detail">
                                            {{data.getNonPlayerCharacter[detail.id]}}
                                        </span>
                                    </p>
                                </section>
